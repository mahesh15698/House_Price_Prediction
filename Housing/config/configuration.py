from Housing.entity.config_entitiy import DataIngestionConfig,DataValidationConfig,DataTransformationConfig,ModelTrainerConfig,ModelEvaluationConfig,ModelPusherConfig,TrainingPipelineConfig
...
class Configuration:
    ...
    def get_data_validation_config(self)->DataValidationConfig:
        try:
            ...
            data_validation_info = self.config_info[DATA_VALIDATION_CONFIG_KEY] #made changes
